...
},{"../../modules/_core":8,"../../modules/es6.object.keys":37}],4:[function(require,module,exports){
...
},{"./_to-absolute-index":30,"./_to-iobject":32,"./_to-length":33}],7:[function(require,module,exports){
...
},{"./_descriptors":11,"./_object-dp":23,"./_property-desc":27}],19:[function(require,module,exports){
...
},{"./_an-object":5,"./_descriptors":11,"./_ie8-dom-define":19,"./_to-primitive":35}],24:[function(require,module,exports){
var has = require('./_has');
var toIObject = require('./_to-iobject');
...
},{"./_array-includes":6,"./_has":17,"./_shared-key":28,"./_to-iobject":32}],25:[function(require,module,exports){
...
},{"./_enum-bug-keys":13,"./_object-keys-internal":24}],26:[function(require,module,exports){
...
},{"./_core":8,"./_export":14,"./_fails":15}],27:[function(require,module,exports){
...
},{"./_core":8,"./_global":16,"./_library":22}],30:[function(require,module,exports){
...
},{"./_defined":10,"./_iobject":20}],33:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer');
var min = Math.min;
module.exports = function (it) {
...
},{"./_defined":10}],35:[function(require,module,exports){
...
},{"./_is-object":21}],36:[function(require,module,exports){
var id = 0;
var px = Math.random();
module.exports = function (key) {
...
},{"got":2}],42:[function(require,module,exports){
(function (process){
/*!
 * Vue.js v1.0.28
 * (c) 2016 Evan You
...
},{"./bootstrap":44,"./components/overtime/index.vue":45,"./components/role/index.vue":46,"./custom":47}],44:[function(require,module,exports){
'use strict';
...
},{"lodash":38,"vue":42,"vue-resource":41}],45:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    computed: {
        totalOvertime: function totalOvertime() {
            var amount = [];
            for (var key in this.overtime) {
                var index = (0, _keys2.default)(this.overtime).indexOf(key);
                amount[index] = 0;
                for (var i = 0; i < this.overtime[key].length; i++) {
                    amount[index] += this.overtime[key][i].total_earned;
                }
    ...
    methods: {
        getEmployees: function getEmployees() {
            ...
            $.ajax({
                ...
                success: function success(data) {
                    _this.employees = JSON.parse(data);
                },
        ...
        getOvertime: function getOvertime(first) {
            var _this2 = this;
            ...
            $.ajax({
                ...
                success: function success(data) {
                    ...
                    _this2.overtime = data;

                    if (_this2.overtime.length < 1 && !first) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-06939c12", module.exports)
  } else {
    hotAPI.update("_v-06939c12", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"babel-runtime/core-js/object/keys":1,"vue":42,"vue-hot-reload-api":40}],46:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-fd41e8b2", module.exports)
  } else {
    hotAPI.update("_v-fd41e8b2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":42,"vue-hot-reload-api":40}],47:[function(require,module,exports){
'use strict';
